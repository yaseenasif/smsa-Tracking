...
export class AuthguardService {
  ...
  PermissionRoutes: { permission: string, route: string[] }[] = [
    ...
    { permission: 'ShipmentRoutesForRoad', route: ['/international-routes-for-road', '/add-international-routes-for-road', '/update-international-routes-for-road/:id','/add-international-by-road-email-list'] },
